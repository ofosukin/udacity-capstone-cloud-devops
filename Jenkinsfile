pipeline {
     ...
     stages {
         ...
         stage('Security Scan') {
              steps {
                  sh "MICROSCANNER_TOKEN=MDY0OThlNDY0YTU5 MICROSCANNER_OPTIONS="--html" ./scan.sh udacity-capstone-cloud-devops:latest"
         ...
         stage('Deploying to AWS') {
              steps{
                  ...
                  withAWS(credentials: '282457606471', region: 'us-west-2') {
